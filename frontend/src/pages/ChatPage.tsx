...
const ChatPage = () => {
	...
	const { messages, getMessage, subscribeMessages, unsubscribeFromMessages } = useMessageStore();
	...
	}, [getMyMatches, authUser, getMessage, subscribeMessages, unsubscribeFromMessages, id]);
